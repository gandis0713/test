...
function vtkSphereHandleRepresentation(publicAPI, model) {
  ...
  publicAPI.requestData = (inData, outData) => {
    // console.log('inData1111111111 : ', inData);
    // console.log('inData.getState() : ', inData[0].getState());
    ...
    for (let i = 0; i < list.length; i++) {
      ...
      // console.log('state.getOrigin() : ', state.getOrigin());
      ...
      // typedArray.color[i] = 0.0;
      // console.log('typedArray.color[i] : ', typedArray.color[i]);
    }
