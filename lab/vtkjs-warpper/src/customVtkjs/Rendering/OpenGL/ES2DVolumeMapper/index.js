...
import vtkVolumeFS from '../glsl/vtkVolumeFS2D.glsl';
...
function vtkES2DOpenGLVolumeMapper(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkES2DOpenGLVolumeMapper');
  ...
  publicAPI.replaceShaderValues = (shaders, ren, actor) => {
    ...
    if (model.zBufferTexture !== null) {
      FSSource = vtkShaderProgram.substitute(FSSource, '//VTK::ZBuffer::Dec', [
        ...
        // 'uniform float vpWidth;', // duplicated define
        // 'uniform float vpHeight;', // duplicated define
      ]).result;
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkES2DOpenGLVolumeMapper(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkES2DOpenGLVolumeMapper');
