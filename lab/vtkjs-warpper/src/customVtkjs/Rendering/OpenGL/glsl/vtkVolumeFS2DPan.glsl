...
{
  pos = get2DPanCoord((vertexDCOutput.x + 1.0) / 2.0, 1.0).xyz + vec3(0, 0, (vertexDCOutput.y + 1.0) / 2.0);
  endPos = get2DPanCoord((vertexDCOutput.x + 1.0) / 2.0, -1.0).xyz + vec3(0, 0, (vertexDCOutput.y + 1.0) / 2.0);
