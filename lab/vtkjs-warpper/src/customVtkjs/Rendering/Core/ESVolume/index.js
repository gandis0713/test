...
function vtkESVolume(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkESVolume');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkESVolume(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkESVolume');
