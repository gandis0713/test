...
function notImplemented(method) {
  return () => macro.vtkErrorMacro(`vtkES2DOutlineMapper::${method} - NOT IMPLEMENTED`);
}

// ----------------------------------------------------------------------------
// vtkES2DOutlineMapper methods
// ----------------------------------------------------------------------------

function vtkES2DOutlineMapper(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkES2DOutlineMapper');
  ...
  publicAPI.mapScalarsToTexture = (scalars, alpha) => {
    ...
    if (
      ...
      publicAPI.getInputData(0).getMTime() > model.colorCoordinates.getMTime() ||
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkES2DOutlineMapper(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkES2DOutlineMapper');
