...
function vtkESCustomPass(publicAPI, model) {
  model.classHierarchy.push('vtkESCustomPass');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkESCustomPass(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkESCustomPass');
