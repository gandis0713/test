...
const transFuncIntensity = vtkColorTransferFunction.newInstance();
transFuncIntensity.addRGBPoint(-1250, 0, 0, 0);
transFuncIntensity.addRGBPoint(4250, 1, 1, 1);
const opaFuncIntensity = vtkPiecewiseFunction.newInstance();
opaFuncIntensity.addPoint(-1250, 1);
opaFuncIntensity.addPoint(4250, 1);

const transFuncInverse = vtkColorTransferFunction.newInstance();
transFuncInverse.addRGBPoint(-1250, 1, 1, 1);
transFuncInverse.addRGBPoint(4250, 0, 0, 0);
const opaFuncInverse = vtkPiecewiseFunction.newInstance();
opaFuncInverse.addPoint(-1250, 1);
opaFuncInverse.addPoint(4250, 1);
...
const VRColoring = {
  ...
  Intensity: {
    color: transFuncIntensity,
    opacity: opaFuncIntensity,
  },
  Inverse: {
    color: transFuncInverse,
    opacity: opaFuncInverse,
  },
};
