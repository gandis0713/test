...
import vtkCustomVolumeMapper from '../customClass/rendering/core/ES3DVolumeMapper';
...
class ESVolumeActor3D extends AbstractActor {
...
export default ESVolumeActor3D;
