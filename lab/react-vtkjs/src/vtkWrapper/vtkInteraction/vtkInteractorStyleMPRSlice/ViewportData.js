...
function validateNumber(numberValue) {
  ...
  throw new Error(`Invalid number ${numberValue}`);
}
...
export default class {
  ...
  _rotate = (viewUp, sliceNormal, dThetaX, dThetaY, dThetaZ = 0) => {
    ...
    const event = new CustomEvent(EVENTS.VIEWPORT_ROTATED, {
      detail: {
  ...
  rotateAbsolute = (dThetaX, dThetaY, dThetaZ = 0) => {
    this._rotate(this._state.viewUp, this._state.sliceNormal, dThetaX, dThetaY, dThetaZ);
  };
