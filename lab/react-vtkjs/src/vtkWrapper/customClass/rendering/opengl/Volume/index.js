...
function vtkCustomOpenGLVolume(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkCustomOpenGLVolume');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkCustomOpenGLVolume(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkCustomOpenGLVolume');
