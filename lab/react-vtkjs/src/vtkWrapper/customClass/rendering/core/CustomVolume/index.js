...
function vtkCustomVolume(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkCustomVolume');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkCustomVolume(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkCustomVolume');
