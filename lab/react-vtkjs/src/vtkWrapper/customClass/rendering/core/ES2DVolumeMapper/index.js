...
// ----------------------------------------------------------------------------
// vtkCustomVolumeMapper methods
// ----------------------------------------------------------------------------

function vtkES2DVolumeMapper(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkES2DVolumeMapper');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkES2DVolumeMapper(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkES2DVolumeMapper');
