...
// ----------------------------------------------------------------------------
// vtkInteractorStyleMPRImage methods
// ----------------------------------------------------------------------------

function vtkInteractorStyleMPRImage(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkInteractorStyleMPRImage');
  ...
  publicAPI.windowLevel = (renderer, position) => {
    ...
    if (model.currentImageProperty) {
      ...
      let dx =
        ((model.windowLevelCurrentPosition[0] - model.windowLevelStartPosition[0]) * 4.0) / size[0];
      let dy =
        ((model.windowLevelStartPosition[1] - model.windowLevelCurrentPosition[1]) * 4.0) / size[1];
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  vtkInteractorStyleMPRImage(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkInteractorStyleMPRImage');
