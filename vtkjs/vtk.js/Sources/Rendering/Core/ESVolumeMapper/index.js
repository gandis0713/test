...
function vtkESVolumeMapper(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkESVolumeMapper');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkESVolumeMapper(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkESVolumeMapper');
