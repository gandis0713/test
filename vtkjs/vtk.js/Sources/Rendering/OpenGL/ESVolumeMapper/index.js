...
// ----------------------------------------------------------------------------
// vtkESOpenGLVolumeMapper methods
// ----------------------------------------------------------------------------

function vtkESOpenGLVolumeMapper(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkESOpenGLVolumeMapper');
  ...
  publicAPI.replaceShaderValues = (shaders, ren, actor) => {
    ...
    publicAPI.replaceShaderClipping(shaders, ren, actor);
  };
  ...
  publicAPI.updateShaders = (cellBO, ren, actor) => {
    ...
    publicAPI.getClippingShaderParameters(cellBO, ren, actor);
  };
  ...
  publicAPI.setCameraShaderParameters = (cellBO, ren, actor) => {
    ...
    // console.log('dcxmin : ', dcxmin);
    // console.log('dcxmax : ', dcxmax);
    // console.log('dcymin : ', dcymin);
    // console.log('dcymax : ', dcymax);
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkESOpenGLVolumeMapper(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkESOpenGLVolumeMapper');
