...
import vtkESOpenGLRenderer from '../ESRenderer';
...
import vtkESOpenGLVolumeMapper from '../ESVolumeMapper';
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  publicAPI.registerOverride('vtkESRenderer', vtkESOpenGLRenderer.newInstance);
  ...
  publicAPI.registerOverride('vtkESVolumeMapper', vtkESOpenGLVolumeMapper.newInstance);
