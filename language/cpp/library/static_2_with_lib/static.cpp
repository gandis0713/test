    ...
    , _sh_1_class(shared_1_class::get_instance())
{
    ...
    cout << "static_2_with_lib_class, shared_1_class::get_instance : " << &shared_1_class::get_instance() << endl;
    cout << "static_2_with_lib_class,                  _sh_1_class : " << &_sh_1_class << endl;
    cout << "static_2_with_lib_class,           static_1_class::id : " << &static_1_class::id << endl;
    cout << "static_2_with_lib_class,           shared_1_class::id : " << &shared_1_class::id << endl;
}
