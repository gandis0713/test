...
{
    cout << "shared_2_with_lib_class::get_static_1_class_instance, _st_1_class : " << &_st_1_class << endl;
    return _st_1_class;
}

shared_1_class& shared_2_with_lib_class::get_shared_1_class_instance()
{
    cout << "shared_2_with_lib_class::get_shared_1_class_instance, _sh_1_class : " << &_sh_1_class << endl;
    return _sh_1_class;
}