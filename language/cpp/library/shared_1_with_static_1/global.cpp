...
int get_shared_1_global_function_with_static_1_global_num()
{
    cout << "get_shared_1_global_function_with_static_1_global_num() : " << static_1_global_num << endl;
...
{
    cout << "print_shared_1_global_function_with_static_1_global_num() : " << static_1_global_num << endl;
}

int get_shared_1_global_function_with_static_1_static_num()
{
    cout << "get_shared_1_global_function_with_static_1_static_num() : " << static_1_static_num << endl;
...
{
    cout << "print_shared_1_global_function_with_static_1_static_num() : " << static_1_static_num << endl;
}